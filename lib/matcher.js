...
function step(dict, sentence) {
    return function (matched) {
        var trie = dict.inspect(),
            results = [], result, i, j, index, temp;
...
module.exports = function (env) {
    var dict = require('./dictionary')(env);

    return function (sentence, base) {
        var fn = step(dict, sentence);
